...
public class AutoJoinQueueScreen extends Screen {
	...
	public boolean mouseClicked(double mouseX, double mouseY, int button) {
		return press(mouseX, mouseY) || super.mouseClicked(mouseX, mouseY, button);
	}

	@Override
	public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
		return drag(mouseY) || super.mouseDragged(mouseX, mouseY, button, deltaX, deltaY);
	}

	@Override
	public boolean mouseReleased(double mouseX, double mouseY, int button) {
		return release() || super.mouseReleased(mouseX, mouseY, button);
	}

	@Override
	public boolean mouseScrolled(double mouseX, double mouseY, double amount) {
		return scrollBy(mouseX, mouseY, amount) || super.mouseScrolled(mouseX, mouseY, amount);
	}
