...
public final class PartyManager {
	...
	public static void tick(MinecraftClient minecraft) {
		...
		if (pendingLeave) {
			pendingLeave = false;
			if (minecraft.world != null) {
				minecraft.world.disconnect(net.minecraft.text.Text.translatable("randomserverfinder.the_party_host_left"));
			}
		}
		...
		if (minecraft.world != null) {
			...
			minecraft.world.disconnect(net.minecraft.text.Text.translatable("randomserverfinder.following_the_party"));
		}
		travelled = true;
	...
	private static String selfName() {
		MinecraftClient minecraft = MinecraftClient.getInstance();
		return minecraft == null || minecraft.getSession() == null ? "Player" : minecraft.getSession().getUsername();
	}
